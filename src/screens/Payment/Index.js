...
const Index = props => {
  ...
  const makePayment = async () => {
    ...
    try {
      ...
      CallApiPost(`/api/stripe-payments/${STORE_ID}`, formdata).then(
        response => {
      ...
      <ScrollView style={{ flex: 1 }}>
        ...
        <View style={{ width: '90%', alignSelf: 'center', marginTop: 16 }}>
          ...
          {/* <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <TouchableOpacity style={{ backgroundColor: '#c70e17', width: '33%', height: 50, alignItems: 'center', justifyContent: 'center', borderRadius: 10 }}>
              <Text style={{ color: '#fff', fontFamily: 'Roboto-Bold', fontSize: 15 }}> APPLY CODE </Text>
            </TouchableOpacity>
          </View> */}
